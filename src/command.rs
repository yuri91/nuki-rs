...
pub const AUTHORIZATION_ID_CONFIRMATION: CommandId = CommandId(0x001E);
pub const AUTHORIZATION_ID_INVITE: CommandId = CommandId(0x001F);
...
pub fn parse(cmd: u16) -> anyhow::Result<CommandId> {
    Ok(CommandId(match CommandId(cmd) {
        ...
        REQUEST_REBOOT => cmd,
        AUTHORIZATION_ID_CONFIRMATION => cmd,
        AUTHORIZATION_ID_INVITE => cmd,
...
impl std::fmt::Display for CommandId {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let id = match *self {
            ...
            AUTHORIZATION_ID_CONFIRMATION => "AUTHORIZATION_ID_CONFIRMATION",
            AUTHORIZATION_ID_INVITE => "AUTHORIZATION_ID_INVITE",
